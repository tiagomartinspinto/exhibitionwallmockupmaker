    ...
    const els = {
      ...
      projectVenue: document.querySelector("#projectVenue"),
      projectDates: document.querySelector("#projectDates"),
      projectPreparedBy: document.querySelector("#projectPreparedBy"),
      projectRevision: document.querySelector("#projectRevision"),
      ...
      exportLabelsPdf: document.querySelector("#exportLabelsPdf"),
      exportPackagePdf: document.querySelector("#exportPackagePdf"),
